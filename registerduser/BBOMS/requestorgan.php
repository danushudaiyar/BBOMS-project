...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
	<title> REGISTERER for Organ </title>
...
<div class="wrapper" >
 ...
 include('connection.php');
  if($_POST['register'])
  {
   ...
   $query = "INSERT INTO requestorgan(fname,gender,bloodgp,donated,email,phone,address,emergency) values ('$fname','$gender','$bloodgp','$donated','$email','$phone','$address','$emergency')";
