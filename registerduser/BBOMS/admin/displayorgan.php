...
while($row=mysqli_fetch_array($result)){
  ...
  <td>".$row['issues']."</td>
       ...
       <td> <a href='updateorgan.php?id=$row[id]'><input type='Submit' value='Update' class='Update'>
       <a href='deleteorgan.php?id=$row[id]'><input type='Submit' value='Delete' class='Delete'onclick = 'return check_delete()''</a></td>
