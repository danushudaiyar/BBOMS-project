...
if(isset($_POST['search']))
{
    ...
    $query = "SELECT * FROM organ bloodbank WHERE CONCAT( `id`, `fname`, `lname`, `Age`, `email`, `relativename`, `relativecontact`, `relativeemail`, `gender`, `bloodgp`, `address`, `donated`, `issues`) LIKE '%".$valueToSearch."%'";
...
<html>
    ...
    <br>  
        ...
        <form action="" method="post" align="center">
            <input type="text" name="valueToSearch" placeholder="Value To Search" size="27" height="7px" >
    ...
    <th>actions</th>
      ...
      <!-- populate table from mysql database -->
                ...
                <tr>
                    ...
                    <td><?php echo $row['relativeemail'];?></td>
                    <td><?php echo $row['gender'];?></td>
                    <td><?php echo $row['bloodgp'];?></td>
                    <td><?php echo $row['address'];?></td>
                    <td><?php echo $row['donated'];?></td>
                    <td><?php echo $row['issues'];?></td>
                    <td> <a href="requestorgan.php" class="Register"><strong>Register</strong></button></a>  
