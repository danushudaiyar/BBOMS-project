...
<html lang="en">
  <head>
    ...
    <title>Search blood you required</title>
    <link rel="stylesheet" href="bloodrequired.css" />
...
outline: none;
      ...
      <body>
      <?php 
  include("admin/searchtable3.php");
  ?>
   <section style="align-items: center;">
  <div class="container" style="align-items: center;" >
      <div class="card">
         <div class="image">
           <img src="registernow.img.jpg"class="pic">
         </div>
               <div class="info">
                     <div class="content">
                      <p class="text1">
                     ...
                     <div class="btn">
                       <a href="usersregisteredinevents.php" class="btn1"><strong>Registernow</strong></button></a>
                     </div>
