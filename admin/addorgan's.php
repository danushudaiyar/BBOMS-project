      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
         ...
         <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Add organ's</li>
          </ol>
    ...
    <div class="form-group">
       ...
       <div class="inputfield">
        <label>relative-email</label>
          <input type="text"  name="relative-email"  required class="input">
       </div> <br> <br>
       <div class="inputfield">
          <label>Gender</label>
...
if($_POST['register'])
{
    ...
    $query = "INSERT INTO organ ( fname,lname,Age,email,relativename,relativecontact,relativeemail,gender,bloodgp,address,donated,issues ) values ('$lname','$fname','$Age','$relativename','$relativecontact','$relativeemail',$gender','$bloodgp','$address','$donated','$issues')";
    ...
    if($data)
    {
        if(!$data){
            ...
            echo" <div style='text-align: center'><h1>Organ registered</h1>";
            echo" <a href='index.php'><h3>Go Back</h3>";
        
        }
        ?>
        <meta http-equiv = "refresh" content = "0; url = http://localhost/admin/displayorgan.php" />
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <a class="btn btn-primary" href="http://localhost/registerduser/BBOMS/">Logout</a>
          </div>
        </div>
      </div>
    </div>
