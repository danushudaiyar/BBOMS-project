      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
          ...
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"> User's Register For Events</li>
          </ol>
...
<table>
  ...
  <table border="3" cellspacing="7" width="74%" align="center"> 
    ...
    <th width="8%">Send certificate</th>
...
while($row=mysqli_fetch_array($result)){
  ...
  <td>".$row['time']."</td>
       ...
       <td> <a href='updateusersreginevents.php?id=$row[id]'><input type='Submit' value='Update' class='Update'>
       <a href='deletereginevent.php?id=$row[id]'><input type='Submit' value='Delete' class='Delete'onclick = 'return check_delete()''</a>
       <td> <a href='sendcert.php?id=$row[id]'><input type='Submit' value='Send' class='Send'></td>
