      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
         ...
         <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Display user's</li>
          </ol>
...
<table>
  ...
  <br><br><br>
  <table border="3" cellspacing="7" width="85%" align="center"> 
    <tr>
    <th width="5%">ID</th>
...
while($row=mysqli_fetch_array($result)){
  ...
  <td>".$row['address']."</td>
  <td>".$row['postal']."</td>
       <td> <a href='updateform.php?id=$row[id]'><input type='Submit' value='Update' class='Update'></td>
      <td> <a href='deleteuser.php?id=$row[id]'><input type='Submit' value='Delete' class='Delete'onclick = 'return check_delete()''</a></td>
