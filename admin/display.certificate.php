          ...
          <div class="dropdown-menu" aria-labelledby="pagesDropdown">
           ...
           <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="pagesDropdown">
              ...
              <a class="dropdown-item" href="displaybloodgroup.php">Organ Request's</a>
...
$qry="select * from certificate";
$result=mysqli_query($conn,$qry);
?>            
<table>
  <h1>Certificates Downloaded data</h1>
  <br>
  <table border="3" cellspacing="7" width="39%" align="center"> 
    <tr>
    <th width="2%">ID</th>
    <th width="8%">Name</th> 
    <th width="8%">donation of</th>
    <th width="8%">EMAIL</th>
    <th width="8%">AGE</th>
