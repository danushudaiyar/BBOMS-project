...
if($_POST['update'])
{
    ...
    $query = " UPDATE bloodbank SET bloodgroup='$bloodgroup',gender='$gender',Quantity='$Quantity' WHERE id='$id'";
    $data  =  mysqli_query($conn,$query);
    if($data)
    {
    ...
    ?>
     <meta http-equiv = "refresh" content = "0; url = http://localhost/admin/displaybloodgroup.php" />
     <?php 
     }
    else
    {
