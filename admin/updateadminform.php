  ...
  <form action="" method="POST">
    <div class="wrapper" style="text-align: center;">
       ...
       <div class="inputfield">
          ...
          <input type="text" value="<?php echo $result['password'];?>" name="password" required class="input">
       </div>  
...
if($_POST['update'])
{
    ...
    ?>
     <meta http-equiv = "refresh" content = "0; url =http://localhost/admin/displayadmin.php" />
     <?php 
     }
    else
    {
